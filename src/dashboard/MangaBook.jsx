...
const MangaBook = () => {
  ...
  return (
    <div className="px-4 my-12">
      <h2 className="mb-8 text-3xl font-bold text-center md:text-left">Manage Your Book</h2>
      <div className="overflow-x-auto">
        <Table className="w-full lg:w-[1180px]">
          <Table.Head>
              ...
              <Table.Row className="bg-white dark:border-gray-700 dark:bg-gray-800">
                ...
                <Table.Cell>
                  ...
                  <button
                    ...
                    className="px-4 py-1 bg-red-500 font-semibold rounded-sm border hover:bg-red-400 text-black"
                  >
                    Delete
                  </button>
                </Table.Cell>
